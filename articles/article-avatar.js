...
box.innerHTML='<div class="avatar-bubble"><div class="avatar-chip">Explicação guiada</div><div class="avatar-title">Resumo do artigo</div><p class="avatar-text">Olá! Eu sou a Rayana virtual. Ative a voz e eu vou explicando o artigo à medida que você desce a página.</p><div class="avatar-status">Áudio desligado. O texto já acompanha a rolagem.</div><div class="voice-row"><label for="rayanaVoiceSelect">Voz feminina</label><select id="rayanaVoiceSelect" class="voice-select"><option value="">Carregando vozes...</option></select></div><div class="avatar-controls"><button class="primary voice" type="button">Ativar voz</button><button class="test" type="button">Testar voz</button><button class="replay" type="button">Repetir</button><button class="min" type="button">Minimizar</button></div></div><div class="avatar-wrap"><div class="avatar-glow"></div><img class="avatar-img" src="rayana.png.png?v=20260915-5" alt="Avatar ilustrado de Rayana Schneider"></div>';
